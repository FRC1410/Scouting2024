...
class AlliancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alliance" do
    assert_difference("Alliance.count") do
      post alliances_url, params: { alliance: { competition_id: @alliance.competition_id, name: @alliance.name } }
    end
  ...
  test "should update alliance" do
    patch alliance_url(@alliance), params: { alliance: { competition_id: @alliance.competition_id, name: @alliance.name } }
